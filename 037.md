---
title:  "Installing UTM and Debian (ISO) on MacOS (Silicon)"
description:
  Installing UTM and Debian (ISO) on MacOS (Silicon)
tagline: Apple Silicon, Mac, UTM, Install Debian ISO
---
...
* The ISO image is/was <span style="color:red; font-weight:bold; font-size:larger;">
  "debian-12.4.0-arm64-netinst.iso"
...
* The UTM version is/was <span style="color:red; font-weight:bold; font-size:larger;">
  "4.4.5"
  </span> --- but this is subject to change.
  * This example will use the previous version, "4.3.5 (5 Aug 2023)"
