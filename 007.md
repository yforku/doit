...
* If copying a **wrong** ".config" file, you might create a massive kernel with huge modules.
  Or, you might want to consider making a ".config" file from scratch with:
...
* FYI Compile Time:
  ...
  * (Windows 10) Lenovo Yoga 300 (Intel(R) Celeron(R) CPU N2840 @2.16GHz)
    * real 5062m4.962s (<span style="color:red;font-weight:bold;">Yes, there is something wrong here!</span>)
    * user 7597m16.164s
    * sys  806m13.830s
...
* URL: <https://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git/>
  * E.g. open TARBALL "linux-firmware-20220509.tar.gz"
  * Go to folder "linux-firmware-20220509/"
  * Copy the missing modules into "/lib/firmware/"
