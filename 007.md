...
Ok, here there are all, and shutup!
...
<br id="idx06">
## OPTION 1: A ".config" file from scratch
* Consider making a ".config" file from scratch with:
...
<br id="idx06a">
## Option 2: Reusing ".config" files
* If copying a **wrong** ".config" file, you might create a massive kernel with huge modules.
* Consider copying a working ".config" file from the "/boot/" directory.
* Or reuse the current one with:
...
<br id="idx06b">
## Option 3: Try this ".config" file
* [Download Config](assets/configs/config-linux-kernel.txt)
  * See also [Linux Kernel Config for VirtualBox](008.md).
